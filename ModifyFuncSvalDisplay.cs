        ...
        public static string ModifyFuncStr(string Funcname, string Funcsval, bool ignoreEnemyFunc)
        {
            ...
            switch (ArrayNum)
            {
                ...
                case 196:
                    ...
                    if (Tempsval.Length == 5)
                    {
                        ...
                        if (Tempsval[4].Contains("ShowQuestNoEffect") ||
                            ...
                            Tempsval[4].Contains("ExecuteEffectId"))
                            try
                            {
                                output = Convert.ToDouble(Tempsval[3]) / 10 + "%" +
                                         (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                        ...
                        if (Tempsval[4].Contains("TriggeredTargetHpRateRange"))
                            try
                            {
                                output = Convert.ToDouble(Tempsval[3]) / 10 + "% (Hp处于" +
                                         Convert.ToDouble(Tempsval[4].Replace("TriggeredTargetHpRateRange:<", "")) /
                                         10 + "%生效)" +
                                         (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                                             ? ""
                                             : "(" + Convert.ToDouble(Tempsval[0]) / 10 + "%成功率)") +
                    ...
                    else if (Tempsval.Length > 5)
                    {
                        if (Tempsval.Length == 7)
                        {
                            ...
                            if (Tempsval[4].Contains("SameBuffLimitTargetIndividuality") &&
                                Tempsval[5].Contains("SameBuffLimitNum") &&
                                Tempsval[6].Contains("ExtendBuffHalfTurnInOpponentTurn"))
                                try
                                {
                                    output = Convert.ToDouble(Tempsval[3]) / 10 + "% * N" +
                                             $" ( N ≤ {Tempsval[5].Replace("SameBuffLimitNum:", "")} )" +
                                             (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                                                 ? ""
                                                 : "(" + Convert.ToDouble(Tempsval[0]) / 10 + "%成功率)") +
                                             (Tempsval[1] == "-1" ? "" : " - " + Tempsval[1] + "回合") +
                        ...
                        if (Tempsval.Length == 6)
                        {
                            ...
                            if (Tempsval[4].Contains("FuncCheckTargetIndividualityTargetType") &&
                                Tempsval[5].Contains("DisplayNoEffectCauses:Avoided"))
                                try
                                {
                                    output = Convert.ToDouble(Tempsval[3]) / 10 + "%" +
                                             (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                            ...
                            if (Tempsval[4].Contains("TriggeredFieldCountTarget") &&
                                ...
                                {
                                    output = Convert.ToDouble(Tempsval[3]) / 10 + "%" +
                                             $" (在场敌人为{Tempsval[4].Replace("TriggeredFieldCountTarget:", "")}个时生效)" +
                                             (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                                                 ? ""
                                                 : "(" + Convert.ToDouble(Tempsval[0]) / 10 + "%成功率)") +
                                             (Tempsval[1] == "-1" ? "" : " - " + Tempsval[1] + "回合") +
                ...
                case 62:
                {
                    ...
                    if (Tempsval.Length == 4)
                    {
                        if (Tempsval[2].Contains("TriggeredFuncPosition") &&
                            Tempsval[3].Contains("DisplayLastFuncInvalidType"))
                            try
                            {
                                output = $"减少{Tempsval[1]}回合" +
                                         (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                        ...
                        if (Tempsval[2].Contains("FuncCheckTargetIndividualityTargetType") &&
                            Tempsval[3].Contains("DisplayNoEffectCauses:Avoided"))
                            try
                            {
                                output = $"减少{Tempsval[1]}回合" +
                                         (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                ...
                case 176:
                    ...
                    if (Tempsval.Length == 5)
                        ...
                        {
                            output =
                                $"∅ (特性{Tempsval[3].Replace("TargetList:", "")} 移除{Tempsval[4].Replace("AllowRemoveBuff:", "")}个)" +
                                (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                                    ? ""
                                    : "(" + Convert.ToDouble(Tempsval[0]) / 10 + "%成功率)");
                        }
                ...
                case 179:
                    ...
                    if (Tempsval.Length == 6)
                        ...
                        {
                            output =
                                $"∅(特性{Tempsval[4].Replace("SameBuffLimitTargetIndividuality:", "")},最大叠加{Tempsval[5].Replace("SameBuffLimitNum:", "")}个)" +
                                (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                                    ? ""
                                    : "(" + Convert.ToDouble(Tempsval[0]) / 10 + "%成功率)");
                        }
                ...
                default:
                    ...
                    if (Tempsval.Length == 4)
                    {
                        ...
                        if (Funcname.Contains("対粛正防御") && Tempsval[3].Contains("ShowState"))
                            try
                            {
                                output = "∅" +
                                         (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                        ...
                        if (Funcname.Contains("弱体無効") && Tempsval[3].Contains("ActSelectIndex"))
                            try
                            {
                                output = "∅" +
                                         (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
            ...
            if (Funcname == "∅" && !Funcsval.Contains("ShowQuestNoEffect"))
            {
                ...
                switch (Tempsval.Length)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5 when Tempsval[4].Contains("Value2") && Tempsval[3].Length == 6:
                        try
                        {
                            var Lv = "1";
                            if (Tempsval[4].Contains("Value2")) Lv = Tempsval[4].Replace("Value2:", "");
                    ...
                    case 6 when Tempsval[4].Contains("ShowState"):
                        ...
                        break;
                    case 6 when Tempsval[5].Contains("ShowState") && Tempsval[3].Length == 6: //暂时屏蔽此处显示(青子需要后续再分析)
                        try
                        {
                            output = "" +
                                     (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
                ...
                Funcname == "毒・呪い・やけど解除" || Funcname == "毒・诅咒・灼伤解除")
            {
                ...
                switch (Tempsval.Length)
                {
                    case 1:
                        ...
                        break;
                    case 2 when Funcname == "毅力解除" || Funcname == "指令卡重分配":
                        try
                        {
                            output =
                                "∅" +
                    ...
                    case 6 when (Funcname == "防御無視" || Funcname == "無敵貫通") &&
                        ...
                        break;
                    case 8 when Funcname == "月下" || Funcname == "日輪":
                        try
                        {
                            output =
                                "∅ (可选释放)" +
                        ...
                        break;
                    case 5 when Funcname == "月下解除" || Funcname == "日輪解除":
                        try
                        {
                            output =
                                "∅ (可选释放)" +
                    ...
                    case 5 when (Funcname == "無敵" || Funcname == "无敌") &&
                                Tempsval[3].Contains("FuncCheckTargetIndividualityTargetType") &&
                                Tempsval[4].Contains("DisplayNoEffectCauses:Avoided"):
                        try
                        {
                            output = "∅" +
                                     (Tempsval[0] == "1000" || Tempsval[0] == "-5000"
            ...
            if (Funcname == "条件判定:孩童从者/夏属性/夏日模式的从者")
            {
                Tempsval = Funcsval.Split(',');
                try
                {
            ...
            if (Funcname.Contains("暫無翻譯")) output = Funcsval;
                        ...
                        try
                        {
                            output = TDStrName + " 【{基础倍率: " +
                                     ...
                                     (Convert.ToDouble(lv1spl[3]) == Convert.ToDouble(lv5spl[3])
                                         ...
                                         : Convert.ToDouble(lv1spl[3]) / 10 + "% - " +
                                           Convert.ToDouble(lv5spl[3]) / 10 + "% ") + "特攻对象:〔" +
                                     SearchIndividualalityTDExcel(lv1spl[4].Replace("AndCheckIndividualityList:", ""))
                                         .Replace(@"/", "∩") + "〕}】\r\n";
                        }
                        catch (Exception)
                        {
